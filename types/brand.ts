 ...
 */
export type TypeOf<T extends Brand<unknown, unknown>> = T extends Brand<infer U, infer _> ? U : never;

/**
 * Obtain the brand of {@link T} extending {@link Brand}.
 */
export type BrandOf<T extends Brand<unknown, unknown>> = T extends Brand<infer _, infer B> ? B : never;
